...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4" style="color: #124E66;"><span class="text-muted fw-light"></span>Update Voter</h4>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Enroll {{$voter->first_name}}'s information</h5>
                                {{--                                <small class="text-muted float-end">Merged input group</small>--}}
                            </div>
                            <div class="card-body">
                                <form action="{{url('/update_voter')}}" method="post">
                                    @csrf
                                    <div class="row mb-3">
                              ...
                              ><i class="bx bx-user"></i
                                  ></span>
                                    ...
                                    <input type="text" name="id" value="{{$voter->id}}" hidden>
